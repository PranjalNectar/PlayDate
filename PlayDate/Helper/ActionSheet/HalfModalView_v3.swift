...
struct HalfModalView<Content: View> : View {
  ...
  //  var modalHeight:CGFloat = 250
    private mutating func onAppear() {
        if isDeleteNotiOpen{
            modalHeight = 150
        }
    }
    ...
    var body: some View {
        ...
        return Group {
            ZStack {
                ...
                Spacer()
                    ...
                    .background(isShown ? Constants.AppColor.appBlack.opacity( 0.4 * fraction_progress(lowerLimit: 0, upperLimit: Double(modalHeight), current: Double(dragState.translation.height), inverted: true)) : Color.clear)
		...
		.gesture(
                ...
                VStack{
                    ...
                    ZStack{
                        //color.opacity(1)
                        Constants.AppColor.appDarkGary.opacity(1)
